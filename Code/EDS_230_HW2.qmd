...
Finally, we can use the [almond_yield](#functions) model to calculate the yield anomalies from the years 1988 to 2010.
...
almond_kable <- kable(almond_summary,
  ...
  kable_title = htmltools::tags$div(style = "text-align: center; font-size: 20px;",
                                    htmltools::tags$strong("Summary of Almond Yield Anomalies<br/><span style='font-size:16px;'>1988–2010</span>")),
  escape = FALSE) %>%
